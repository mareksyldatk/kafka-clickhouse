...
- Brokers/controllers unhealthy: ensure `CLUSTER_ID` is set in `.env`, volumes aren’t from an old incompatible run, and check `docker compose logs kafka-controller-*`.
